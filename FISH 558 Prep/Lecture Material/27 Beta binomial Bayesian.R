#==============================================
#Example of conjugate priors for FISH458
#Created by Cole Monahan, May 2012
#The likelihood is binomial, the prior is the beta.
#Use manipulate to update the prior and posterior in real time. 
#==============================================
library(stats)
library(manipulate)
...
plot.beta.binomial <- function(Deaths=5, Survivors=4, alpha=1.5,
    ...
    ## Plot them
    plot(p.seq, likelihood, type="l", lwd=2, col=1,
         ylab="Scaled Likelihood/Density",
         xlab="Probability of Survival (p)", xlim=c(0,1), ylim=c(0,1))
    ...
    par(xpd=TRUE)
    legend(x=0, y=1.15, legend=c("Likelihood", "Confidence Interval",
