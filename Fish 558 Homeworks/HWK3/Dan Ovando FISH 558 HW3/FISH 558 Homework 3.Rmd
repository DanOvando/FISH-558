...
$$NLL = \sum \frac{ (log(N_{a = 1:x}^{Predicted} ) -  log(N_{a = 1:x}^{Observed}))^{2}}{2{\sigma}^{2}}$$
...
```{r fig 11 nvk, fig.cap= 'Distribution of N/K from the posterior of the post-data SIR under three future catch scenarios'}
