...
results <- run.jags(model=model, monitor=c("coef", "int", "precision","sigma","true.y"),
...
ggmcmc(ggs(results), file="model_simple-diag.pdf")


#plot(results,plot.type="trace",layout=c(6,6))
